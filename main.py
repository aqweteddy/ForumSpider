...
parser.add_argument('--ptt_page', type=int, default=2, help='ptt spider pages for each board')
...
# 政治&時事 廢文 3C 閒聊 生活 汽機車 感情 Money 電玩 電影 動漫 追星 joke 運動 旅遊 其他
